...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "champ_assistant.crash_report",
        "champ_assistant.safe_mode",
        "champ_assistant.session_summary",
        "champ_assistant.telemetry",
        "champ_assistant.vision",
        "champ_assistant.vision.capture",
        "champ_assistant.vision.color_detector",
        "champ_assistant.vision.config",
        "champ_assistant.vision.observation_service",
        "champ_assistant.vision.scoreboard_detector",
        "champ_assistant.vision.scoreboard_visibility_service",
        "champ_assistant.vision.transition_detector",
        "champ_assistant.game",
        "champ_assistant.game.gold_diff_service",
        "champ_assistant.ui.scoreboard_overlay",
