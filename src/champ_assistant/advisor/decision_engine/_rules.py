...
# Summoner-cooldown rules live in rules/summoner_cd.py — re-exported here
# so existing call sites (``from ._rules import rule_enemy_flash_down``)
# keep working. They are NOT in ``ALL_RULES``; ``_evaluate.evaluate``
